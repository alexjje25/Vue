  ...
  <div class="cadastroMD">
    ...
    <div class="scope fundoVideo">
      <div class="videoScope ">
        ...
        <div class="texto">
          <p>
            Teste de uso da plataforma Rurall Strong 4.0 por 30 dias gratuitos
      ...
      <div class="form md1">
        ...
        <div class="g g2">
          ...
          <input
            ...
            placeholder="Telefone 1 / Whatsapp - DDD 00000 0000"
            @input="include.telefone1 = $event.target.value"
          />
          <input
            type="number"
            :value="include.telefone2"
            placeholder="Telefone 2 - DDD 00000 0000"
          ...
          <select
            ...
            placeholder="Pacote"
            title="PLANO"
            :value="include.pacote"
            @input="include.pacote = $event.target.value"
          >
            <option value="TRIAL TESTE">TRIAL TESTE</option>
          </select>
          <div>
            <select
              class="blueForm"
          ...
          <input
            v-if="include.docType == 'cpf'"
            class="blueForm"
            type="number"
            placeholder="CPF"
            :value="include.documentoCPF"
            @input="include.documentoCPF = $event.target.value"
          />
          <input
        ...
        <div class="g g2">
          ...
          <input
            type="text"
            :value="include.endereco.cep"
            placeholder="CEP"
            @input="include.endereco.cep = $event.target.value"
          />
          <input
            type="text"
            :value="include.endereco.complemento"
            placeholder="Complemento"
            @input="include.endereco.complemento = $event.target.value"
          />
        </div>
...
<script>
import { servUsers, firebase, servClientes, servFazendas } from "@/database.js";
export default {
  data() {
    return {
      processando: false,
  ...
  methods: {
    ...
    CADASTRO() {
      ...
      this.include.fazenda.idFazenda = servFazendas.push().key;
      // Registros
    ...
    CADASTRO_FAZENDA() {
      ...
      //controle perpetuo.
      servFazendas.child(referencia).update(self.include.fazenda, function() {
    ...
    CADASTRAR_CLIENTE() {
      ...
      servClientes.child(self.include.chave).update(payload, function() {
        self.CADASTRO_FAZENDA();
      });
    },
    enviar() {
      if (this.include.docType == "cpf") {
