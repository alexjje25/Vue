    ...
    >
      ...
      >
        <MglPopup class="boxContainPoint">
          <div>
            <div class="titulo">{{ item.dados.nomeArmadilha }}</div>
            <div class="conteudo">
              <div class="boxGrid">
                <div class="centralizaTudo">
                  <div class="tt">REVISÕES</div>
                  <div class="dd" style="font-size: 15px;">
                    <vReviewItem :chaveArmadilha="item.chave" />
                  </div>
                </div>
                <div>
                  <div class="tt">LAT / LONG</div>
                  <div class="tt">
                    <small>{{ item.dados.coord.long }}, {{ item.dados.coord.lat }}</small>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div slot="marker">
          <div>
            <img class="icone" src="./icon/armadilha.png" />
          </div>
        </div>
      </MglMarker>
...
import vReviewItem from "@/views/dash/gerencia/armadilhas/reviewsTotalItem";
...
export default {
  ...
  computed: {
    GET_REVIEWS() {
      return this.$store.getters["fazenda/GET_REVIEW_TRAPS"];
    },
    GET_TALHOES() {
