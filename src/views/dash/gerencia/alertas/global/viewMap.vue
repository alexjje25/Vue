  ...
  <div>
    ...
    >
      ...
      >
        <MglPopup>
          <div>
            <div class="titulo">{{ item.dados.nameAlerta }}</div>
            <div class="conteudo">
              <div class="boxGrid">
                <div>
                  <div>
                    <div class="tt">Producao</div>
                    <div class="dd">{{ item.dados.nomeProducao }}</div>
                  </div>
                  <div>
                    <div class="tt">Observação</div>
                    <div class="dd">{{ item.dados.observacao }}</div>
                  </div>
                  <div>
        ...
        <div slot="marker">
          <div>
            <div>
              <img class="icone" src="./icon/mapa-alerta.png" />
            </div>
          </div>
        </div>-->
      </MglMarker>
...
.marker {
  background-image: url("./icon/mapa-alerta.png");
