    ...
    <div v-else class="form">
      ...
      <div v-if="rota == 'especie'">
        ...
        <select v-model="includeEspecie.tipo">
          ...
          <option
            v-for="(item, index) in daninhasTipo"
            :key="index"
            :value="item.chave"
      ...
      <div v-if="rota == 'estagio'" class="listaEstagio">
        ...
        <div class="scope">
          ...
          <div class="include">
            <select v-model="includeEstagio.especie">
              <option value="selecione">selecione</option>
              <option
                v-for="(item, index) in daninhasEspecie"
                :key="index"
                :value="item.chave"
                >{{ item.dados.name }}</option
              >
        ...
        <div class="scope">
          ...
          <div
            v-for="(estagio, index) in daninhasEstagio.filter(
              item => includeEstagio.especie == item.dados.especie
            )"
            :key="index"
            class="item"
...
export default {
  ...
  methods: {
    ...
    sendPrioritaryImage(referenciaURL, chave) {
      servDaninhasEspecie.child(chave).update({ imagemURL: referenciaURL });
    },
    uploadImagem() {
      const self = this;
    ...
    createTipo() {
      this.includeTipo.chave = servDaninhasTipo.push().key;
      servDaninhasTipo
    ...
    createEspecie() {
      ...
      this.includeEspecie.chave = servDaninhasEspecie.push().key; //get key push
      //this.uploadImagem();
      servDaninhasEspecie
    ...
    createEstagio() {
      ...
      this.includeEstagio.chave = servDaninhasEstagio.push().key;
      servDaninhasEstagio
